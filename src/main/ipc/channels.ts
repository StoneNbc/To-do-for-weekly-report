...
export const IPC = {
  ...
  projectsDeleteEmpty: 'projects:delete-empty',
  projectsPreviewRename: 'projects:preview-rename',
  projectsRename: 'projects:rename',
  projectsRetryRecovery: 'projects:retry-recovery',
  projectsOpenRecoveryFolder: 'projects:open-recovery-folder',
  todayMoveMany: 'today:move-many',
  ...
  historyGetView: 'history:get-view',
  historyAddPending: 'history:add-pending',
  historyEditPending: 'history:edit-pending',
  historyDeletePending: 'history:delete-pending',
  historyCompletePending: 'history:complete-pending',
  historyReopenCompleted: 'history:reopen-completed',
  ...
  windowOpenProjectCreate: 'window:openProjectCreate',
  windowCloseProjectCreate: 'window:closeProjectCreate',
