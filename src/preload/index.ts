...
const api: ElectronAPI = {
  ...
  history: {
    ...
    addPending: (input) => ipcRenderer.invoke(IPC.historyAddPending, input),
    editPending: (input) => ipcRenderer.invoke(IPC.historyEditPending, input),
    deletePending: (input) => ipcRenderer.invoke(IPC.historyDeletePending, input),
    completePending: (input) => ipcRenderer.invoke(IPC.historyCompletePending, input),
    reopenCompleted: (input) => ipcRenderer.invoke(IPC.historyReopenCompleted, input),
